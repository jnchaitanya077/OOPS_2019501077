...
public class CSVReader {
    ...
    /**
     * The number of rows in the given data frame. Note: This shouldn't include the
     * coloumn labels.
     * 
    ...
    /**
     * This method returns the name of the column based on the index passed as a
     * parameter
     * 
    ...
    /**
     * This method returns the row (array of values) based on the parameter passed
     * to the method.
     * 
     ...
     */
    public String[] getRows(int fromIndex, int toIndex) { // validation
        // TODO
        // Your code goes here....
