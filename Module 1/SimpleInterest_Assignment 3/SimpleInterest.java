 ...
 * Interest. You can check for the test cases in the TestJUnit.java
 * 
 * @author Siva Sankar
 */
...
public class SimpleInterest {
     ...
     * 
     * @return the interest calculated for the given values of principle, rate of
     *         interest and time period (Number of years)
     */
    public static double simpleInterest(double principle, double numberOfYears, double rateOfInterest) {
        // Your code goes here....
        double SI;
        SI = (principle * numberOfYears * rateOfInterest) / 100.0;
        return SI;
