...
public class InTenTwenty {
    ...
    /**
     * This method should return true if either of the tow numbers as parameters are
     * in the range of 10..20 inclusive, false otherwise.
     * 
     * @param a, the first integer as parameter to the method.
     * @param b, the second integer as parameter to the method.
     * 
     * @return true if either of them is in the range of 10..20 inclusive and false
     *         otherwise.
     */
