...
public interface ListInterface {
     ...
     * @return the lastIndexOf item from this list If the item is not there, return
     *         -1
     */
     ...
     * @return the number of occurnaces of the item in this list. If the item is not
     *         there, return -1
     */
    public int count(int item);

    /**
     * Returns the subList of elements that are in the index range of fromIndex to
     * toIndex
     * 
